...
- **Global scope**: `/Users/owenmionnet/deve/perso/MAC/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/owenmionnet/deve/perso/MAC/.claude/notes/`)
...
2. Glob `/Users/owenmionnet/deve/perso/MAC/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/owenmionnet/deve/perso/MAC/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/owenmionnet/deve/perso/MAC/.claude/notes/` — works in any directory
