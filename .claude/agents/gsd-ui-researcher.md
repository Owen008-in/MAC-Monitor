...
Use template from `/Users/owenmionnet/deve/perso/MAC/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/owenmionnet/deve/perso/MAC/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/owenmionnet/deve/perso/MAC/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
